...
namespace ShoppingCenter.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public ActionResult Create(Customer customer)
        {
            ...
            {
                db.Customers.Add(customer);//NOW THE NEW DATA IS IN MEMORY, BUT NOT IN DATABASE
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,DOB,IsSubscribedToNewsLetter,MembershipTypeId")] Customer customer)
        {
            if (ModelState.IsValid)
            {
